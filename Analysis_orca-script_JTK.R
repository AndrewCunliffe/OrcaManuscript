...
home <- "/Users/au646044/ScratchFolder"
...
# Load datasets ----
  ...
  #Here I added mean NDVI across the 4 flight measurements
...
# Figure 3. NEW including NDVI ----
  ...
  NDVI_vs_leaf_biomass_121 <- ggplot(data = dataset, aes(x = mean_NDVI_121, y = log(leaf_biomass))) + 
    geom_point(shape = 1, na.rm = TRUE) + geom_text(aes(label=PlotID),hjust=0, vjust=0) +
